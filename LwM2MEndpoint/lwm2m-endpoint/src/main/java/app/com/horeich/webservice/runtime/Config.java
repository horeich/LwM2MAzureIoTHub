...
// import app.com.horeich.webservice.auth.ClientAuthConfig;
...
public class Config implements IConfig {
    ...
    private final String NAMESPACE = "app.com.horeich.";
    private final String APPLICATION_KEY = NAMESPACE + ""; // TODO: change to app name
    ...
    private final String REGISTRATION_URL = APPLICATION_KEY + "registrationUrl";
    private final String TELEMETRY_URL = APPLICATION_KEY + "telemetryUrl";
    ...
    public IServicesConfig getServicesConfig() {
        ...
        this.servicesConfig = new ServicesConfig(
                this.data.getString(TELEMETRY_URL),
                ...
                this.data.getString(REGISTRATION_URL));
                //actionsConfig);
