...
public class GenericSensorDemo {

    private static final Logger log = LoggerFactory.getLogger(GenericSensorDemo.class);
    ...
    public static void main( String[] args )
    {
        ...
        try
        {
            ...
            TelemetryModule telemetryModule = new TelemetryModule(); // random sensor data generator
            TelemetryObject telemetryObject = new TelemetryObject(telemetryModule);
            TelemetryObserver telemetryObserver = new TelemetryObserver(telemetryObject, telemetryModule);
    ...
    private static LwM2mModel createModel() throws Exception {
        ...
        String[] modelPaths = new String[] { "64000.xml", "64001.xml", "3303.xml"};
