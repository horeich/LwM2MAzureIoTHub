...
public class LevelTelemetryObserver extends LwM2mClientObserverAdapter {
    ...
    private LevelTelemetryObject telemetryObject;

    public LevelTelemetryObserver(LevelTelemetryObject telemetryObject, LevelTelemetryModule telemetryModule) {
